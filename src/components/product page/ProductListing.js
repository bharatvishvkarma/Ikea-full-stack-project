...
import Loading from "../singleProduct page/loading";
// import ".../App.css"
...
const ProductPage = () => {
  ...
  const fetchProducts = () => {
    axios.get(`https://azure-rhinoceros-cap.cyclic.app/products?sort=${sort}&category=${category}&price=${price}`)
      .then((res) =>{
    ...
    <div className="ui grid container">
      {
       ...
       {/* <p  > An efficient work setup in the comfort of your home</p> */}
