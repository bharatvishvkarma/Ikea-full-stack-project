...
export default function Navbar() {
  ...
  useEffect(() => {
    axios.get("https://azure-rhinoceros-cap.cyclic.app/products?sort=&category=&price=")
      .then((res) => {
        // console.log(res)
        ...
        <div className="right-header">
          ...
          >
            ...
            <div class="offcanvas-body">
              <div id="loggin">
                <h2>Hej <span className="hej">{isAuth.isAuth?isAuth.login.name.toUpperCase():""}</span></h2>
                <button style={{padding:"10px"}} data-bs-dismiss="offcanvas" onClick={() => {
